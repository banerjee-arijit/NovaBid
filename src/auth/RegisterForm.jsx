      ...
      <div className="relative z-10 w-full max-w-5xl bg-black/60 backdrop-blur-xl border border-cyan-500/10 rounded-2xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="p-8 md:p-12">
          ...
          >
            ...
            <button className="w-full py-3 px-4 bg-gradient-to-r from-cyan-500 to-cyan-400 hover:from-cyan-400 hover:to-cyan-300 text-black font-semibold rounded-xl flex items-center justify-center gap-2 transition-all duration-300 transform hover:scale-[1.02]">
